...
export default async function AnalyticsPage({
  ...
  return <div data-full-bleed className="analytics-page">
    ...
    <div className="analytics-toolbar"><Suspense fallback={<div className="h-8" />}><AnalyticsControls range={rangeValue} rangeLabel={preset.custom ? rangeLabel : preset.label} from={dayValue(from)} to={dayValue(to)} compare={compare} currency={currency} /></Suspense><LastRefreshed at={refreshedAt} /></div>
