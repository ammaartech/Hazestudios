...
const ACTIONS: CommandSpec[] = [
  ...
  { title: "Delivery tracking — Qikink", href: "/admin/orders/tracking/qikink", section: "Orders", keywords: ["awb", "courier", "shipment", "qikink", "tracking"] },
  { title: "Delivery tracking — Shree Maruti", href: "/admin/orders/tracking/shreemaruti", section: "Orders", keywords: ["awb", "courier", "shipment", "shree maruti", "shreemaruti", "tracking"] },
  { title: "Delivery tracking — Bluedart", href: "/admin/orders/tracking/bluedart", section: "Orders", keywords: ["awb", "courier", "shipment", "bluedart", "blue dart", "tracking"] },
