  ...
  if (cart.lines.length === 0) {
    return (
      <div className="mx-auto flex max-w-md flex-col items-center gap-6 px-4 py-24 text-center md:py-32">
        ...
        <Link
          href="/"
          className="glass glass-pill glass-press glass-primary flex min-h-14 cursor-pointer items-center px-8 text-base font-medium focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--shop-ink)"
        >
          Shop the drop
        </Link>
      </div>
        ...
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="glass glass-panel p-6">
            ...
            {canCheckout ? (
              <Link
                href="/checkout"
                className="glass glass-pill glass-press glass-primary mt-6 flex min-h-14 w-full cursor-pointer items-center justify-center gap-2 px-8 text-base font-medium focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--shop-ink)"
              >
                Checkout
              ...
              <button
                type="button"
                disabled
                className="glass glass-pill mt-6 flex min-h-14 w-full cursor-not-allowed items-center justify-center gap-2 bg-(--shop-cloud) px-8 text-base font-medium text-(--shop-stone) shadow-none"
              >
                Checkout
                <ArrowRight className="size-4" aria-hidden />
              </button>
